  ...
  Ticket.find(query)
    ...
    .then(function(tickets) {
      ...
      tickets.forEach(ticket => {
        result +=
          '<li><div class="avatar"><img src="/assets/img/icon-tour.png" class="img-responsive img-circle"></div><div class="content"><span class="msg"><a href="#" class="person">' +
          ticket.service.name +
          "</a><br> " +
          ticket.customer.name +
          '</span><span class="time">' +
          DateHelper.convertDate(ticket.date) +
          "</span></div></li>";
      });
