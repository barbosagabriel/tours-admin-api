...
var pdfHelper = function(){
    ...
    const VOUCHER_TEMPLATE={header:{columns:[{text:"",style:"documentHeaderLeft"},{text:"",style:"documentHeaderCenter"},{text:"",style:"documentHeaderRight"}]},footer:{columns:[{text:"{{COMPANY_PHONE_1}} | {{COMPANY_PHONE_2}} \n {{COMPANY_EMAIL}}",style:"documentFooterLeft"},{text:"{{COMPANY_WEBSITE}} \n {{COMPANY_INSTAGRAM}}",style:"documentFooterCenter"},{text:"{{COMPANY_ADDRESS}} \n {{COMPANY_ADDRESS_LINE2}}",style:"documentFooterRight"}]},content:[{columns:[{image:"{{LOGO}}",width:150},[{text:"VOUCHER",style:"invoiceTitle",width:"*"},{stack:[{columns:[{text:"#",style:"invoiceSubTitle",width:"*"},{text:"{{VOUCHER_NUMBER}}",style:"invoiceSubValue",width:100}]},{columns:[{text:"Data de Emissão",style:"invoiceSubTitle",width:"*"},{text:"{{DATE_OF_ISSUE}}",style:"invoiceSubValue",width:100}]},{columns:[{text:"Data Realização",style:"invoiceSubTitle",width:"*"},{text:"{{DATE}}",style:"invoiceSubValue",width:100}]}]}]]},{columns:[{text:"Agência",style:"invoiceBillingTitle"},{text:"Cliente",style:"invoiceBillingTitle"}]},{columns:[{text:"{{COMPANY_NAME}} \n {{GUIDE_NAME}}",style:"invoiceBillingDetails"},{text:"{{CUSTOMER_NAME}} \n {{CUSTOMER_HOTEL}}",style:"invoiceBillingDetails"}]},"\n\n",{table:{headerRows:1,widths:["*",40,"auto","auto"],body:[[{text:"Serviço",style:"itemsHeader"},{text:"Qtd.",style:["itemsHeader","center"]},{text:"Valor (US$)",style:["itemsHeader","center"]},{text:"Total (US$)",style:["itemsHeader","center"]}],[[{text:"{{SERVICE_NAME}}",style:"itemTitle"},{text:"{{SERVICE_SHORT_DESCRIPTION}}",style:"itemSubTitle"}],{text:"{{QUANTITY}}",style:"itemNumber"},{text:"{{UNIT_PRICE}}",style:"itemNumber"},{text:"{{ITEM_TOTAL}}",style:"itemTotal"}]]},layout:"lightHorizontalLines"},{table:{headerRows:0,widths:['*',80],body:[[{text:'Desconto',style:'itemsFooterTotalTitle'},{text:'{{DISCOUNT}}',style:'itemsFooterTotalValue'}],]},layout:'lightHorizontalLines'},{table:{headerRows:0,widths:['*',80],body:[[{text:'TOTAL',style:'itemsFooterTotalTitle'},{text:'{{TOTAL}}',style:'itemsFooterTotalValue'}],]},layout:'lightHorizontalLines'}],styles:{documentHeaderLeft:{fontSize:10,margin:[5,5,5,5],alignment:"left"},documentHeaderCenter:{fontSize:10,margin:[5,5,5,5],alignment:"center"},documentHeaderRight:{fontSize:10,margin:[5,5,5,5],alignment:"right"},documentFooterLeft:{fontSize:8,margin:[5,5,5,5],alignment:"center"},documentFooterCenter:{fontSize:8,margin:[5,5,5,5],alignment:"center"},documentFooterRight:{fontSize:8,margin:[5,5,5,5],alignment:"center"},invoiceTitle:{fontSize:22,bold:!0,alignment:"right",margin:[0,0,0,15]},invoiceSubTitle:{fontSize:12,alignment:"right"},invoiceSubValue:{fontSize:12,alignment:"right"},invoiceBillingTitle:{fontSize:14,bold:!0,alignment:"left",margin:[0,20,0,5]},invoiceBillingDetails:{alignment:"left"},invoiceBillingAddressTitle:{margin:[0,7,0,3],bold:!0},invoiceBillingAddress:{},itemsHeader:{margin:[0,5,0,5],bold:!0},itemTitle:{bold:!0},itemSubTitle:{italics:!0,fontSize:11},itemNumber:{margin:[0,5,0,5],alignment:"center"},itemTotal:{margin:[0,5,0,5],bold:!1,alignment:"center"},itemsFooterTotalTitle:{margin:[0,5,0,5],bold:!0,alignment:'left',},itemsFooterTotalValue:{margin:[0,5,0,5],bold:!0,alignment:'right',},notesTitle:{fontSize:10,bold:!0,margin:[0,50,0,3]},notesText:{fontSize:10,aligment:"justified"},center:{alignment:"center"}},defaultStyle:{columnGap:20}};
    ...
    function _getVoucherTemplate(){
        return JSON.parse(JSON.stringify(VOUCHER_TEMPLATE));
    }
    ...
    function _generateVoucherFilename(ticket){
        var customerName = ticket.customer.name.toUpperCase().replace(/\s+/g, '_');
